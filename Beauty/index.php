...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <a class="navbar-brand" href="http://www.shiyanlou.com">Campus ranking</a>
      </div>
    </nav>
    <div class="container">
      <div class="main">
        ...
        <div class="alert alert-info alert-dismissible" role="alert" hidden="">
          ...
          <strong>!</strong>two girls, who do you think is more beautiful~
        </div>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted"><h4>Campus campus Belle ranking selection</h4><h5>www.bohongtao.club</h5></p>
      </div>
    </footer>
    <script src="./js/jquery.min.js"></script>
    <script>
